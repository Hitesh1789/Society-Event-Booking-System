    ...
    authStatus ? (<Sidebar className="border-r min-h-screen">
        ...
        <div className="border-t p-3">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex w-full items-center gap-3 rounded-xl p-2 hover:bg-purple-100 transition">
      ...
      (<Sidebar className="border-r min-h-screen">
        <SidebarContent className="flex flex-col h-full">
          ...
          {/* Bottom Profile Section */}
          <div className="p-2 cursor-pointer border-t flex items-center gap-3" onClick={() => navigate("/login")}>
